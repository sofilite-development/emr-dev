        ...
        (function() {
            ...
            app.controller('inboxCtrl', ['$scope', '$filter', '$http', '$window', '$q', function($scope, $filter, $http, $window, $q) {
                    ...
                    $scope.batchDelete = function(i) {
                        ...
                        $http.post('handle_note.php', $.param({
                            'task': 'massdelete',
                            'notejson': JSON.stringify(itemToDelete),
                            'csrf_token_form': $scope.csrf
                    ...
                    $scope.getAllMessages = function() {
                        return $http.post('handle_note.php', $.param({
                            'task': 'getall',
                            'csrf_token_form': $scope.csrf
                        })).then(function successCallback(response) {
                            if (response.data) {
            ...
            <div class="row" ng-class="{'d-none': isInit}">
                <div class="col-12">
                    <div class="alert alert-info">
                        <h3><?php echo xlt("Loading..."); ?> <i class="wait fa fa-cog fa-spin ml-2"></i></h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12 mb-2">
                            ...
                            <div class="btn-group btn-group float-right">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li ng-show='!isTrash'>
                                        <a class="dropdown-item" href="javascript:;" ng-click="batchDelete(items)"><i class="fa fa-trash"></i> <?php echo xlt('Send Selected to Archive'); ?></a>
                                    </li>
                                    <li>
