...
if (empty($_REQUEST['site']) && $allow_multisite_setup && empty($state)) {
    ...
    <html>
    <head>
        <title>QuantumleapEMR Setup Tool</title>
    ...
    <body>
        <nav class="navbar navbar-expand navbar-light bg-light">
           <div class="container">
           <a class="navbar-brand" href="#">QuantumleapEMR Setup</a>
                    ...
                    <div class="jumbotron p-5">
                        ...
                        <ul>
                            ...
                            <li>To ensure a consistent look and feel throughout the application,
                                <a href='http://www.mozilla.org/products/firefox/'>Firefox</a> and <a href="https://www.google.com/chrome/browser/desktop/index.html">Chrome</a> are recommended. The OpenEMR development team exclusively tests with modern versions of these browsers.
                            </li>
