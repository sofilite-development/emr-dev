    ...
    <?php if (empty($GLOBALS['PATIENT_REPORT_ACTIVE'])) { ?>
        <script>
            ...
            function showpnotes(orderid) {
                let url = top.webroot_url + '/interface/patient_file/summary/pnotes_full.php?orderid=' +
                    <?php echo js_url($orderid); ?>;
        ...
        <div class='labres table-responsive'>
            <table class="table table-sm">
                ...
                <tr>
                    ...
                    <td> Hello <?php echo myCellText($orow['lname'] . ', ' . $orow['fname'] . ' ' . $orow['mname']); ?></td>
                ...
                <?php
                // Query to check if order exists in processed_order table
                $processed = sqlQuery(
                ...
                <tr>
                    ...
                    <td class="border-0 text-right align-top">
                        <?php if ($input_form && !empty($ctx['priors_omitted']) /* empty($_POST['form_showall']) */) { ?>
                            <input type='submit' class='btn btn-primary' name='form_showall'
                                value='<?php echo xla('Show All Results'); ?>'
                                title='<?php echo xla('Include all values reported for each result code'); ?>' />
                        <?php } elseif ($input_form && !empty($_POST['form_showall'])) { ?>
                            <input type='submit' class='btn btn-primary' name='form_latest'
                                value='<?php echo xla('Latest Results Only'); ?>'
                        ...
                        <?php if ($input_form && $ctx['sign_list']) { ?>
                            &nbsp;
                            <input type='hidden' class='btn btn-primary' name='form_sign_list'
                                value='<?php echo attr($ctx['sign_list']); ?>' />
                            <input type='submit' class='btn btn-primary' name='form_sign'
                                value='<?php echo xla('Sign Results'); ?>'
                                title='<?php echo xla('Mark these reports as reviewed'); ?>' />
                        <?php } ?>
                        <?php if ($input_form) { ?>
                            &nbsp;
                            <input type='button' class='btn btn-danger' value='<?php echo xla('Close'); ?>'
