...
<form id="app_form" method="POST" autocomplete="off">
    <div class="<?php echo $loginrow; ?> card m-5">
        <div class="<?php echo attr($logoarea); ?>">
            ...
            <?php } ?>
            <p class="text-.enter lead font-weight-normal login-bg-text-color text-white"><?php echo xlt('The most popular Electronic Health Record and Medical Practice Management solution.'); ?></p>
