    ...
    <div class="container">
        ...
        <table border='0'>
                    ...
                    <form name='new_user' id="new_user" method='post' action="usergroup_admin.php"
                        ...
                        <table class="border-0" cellpadding='0' cellspacing='0' style="width:600px;">
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="file" id="signature-user" name="signature-user" accept="image/*"
                                        class="form-control">
                                    <br>
                                    <img id="signaturePreview" src="#" alt="Signature Preview"
                                        style="display:none; max-width: 300px; height: auto; border: 1px solid #ccc;">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
                            ...
                            <tr>
                                ...
                                <?php if (empty($GLOBALS['gbl_ldap_enabled']) || empty($GLOBALS['gbl_ldap_exclusions'])) { ?>
                                    ...
                                    <td style="width:150px;">
                                        <input type="password" style="width:120px;" name="stiltskin" id="stiltskin"
                                            class="form-control" onkeyup="checkPasswordStrength(this);">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input required type="email" name="email" id="email" style="width:200px;"
                                        class="form-control">
                                    <span class="mandatory"></span>
                                </td>
                            </tr>
            ...
            <tr>
                ...
                <td class='text' style="width:280px;"><input type='password' name=adminPass style="width:120px;"
            ...
            <tr>
                ...
                <td><input type="text" name='fname' id='fname' style="width:120px;" class="form-control"><span
            ...
            <tr>
                ...
                <td><input type="text" name='lname' id='lname' style="width:120px;" class="form-control"><span
                        class="mandatory"></span></td>
            ...
            <tr>
                ...
                <td><input type="text" name="taxonomy" style="width:120px;" class="form-control" value="207Q00000X">
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="google_signin_email" style="width:150px;" class="form-control"
                        value="<?php echo attr($iter["google_signin_email"] ?? ''); ?>"></td>
            </tr>
            ...
            <?php if (!empty($GLOBALS['gbl_fac_warehouse_restrictions']) || !empty($GLOBALS['restrict_user_facility'])) { ?>
                <tr title="<?php echo xla('If nothing is selected here then all are permitted.'); ?>">
                    <td class="text">
                        <?php echo !empty($GLOBALS['gbl_fac_warehouse_restrictions']) ?
                            xlt('Facility and warehouse permissions') : xlt('Facility permissions'); ?>:
                    </td>
                    <td colspan="3">
