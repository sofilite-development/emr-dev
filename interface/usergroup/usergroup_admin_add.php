...
<body class="body_top">
    ...
    <div class="container">
        ...
        <table border='0'>
            ...
            <tr>
                <td valign='top'>
                    <form name='new_user' id="new_user" method='post' action="usergroup_admin.php" enctype="multipart/form-data">
                        ...
                        <table class="border-0" cellpadding='0' cellspacing='0' style="width:600px;">
                            <tr>
                                <td><span class="text"><?php echo xlt('Upload Signature'); ?>: </span></td>
                                <td colspan="3">
                                    <input type="file" id="signature-user" name="signature-user" accept="image/*" class="form-control">
                                    <br>
                                    <img id="signaturePreview" src="#" alt="Signature Preview" style="display:none; max-width: 300px; height: auto; border: 1px solid #ccc;">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
                            ...
                            <tr>
                                ...
                                <td style="width:220px;"><input type="text" name="rumple" style="width:120px;" class="form-control"><span class="mandatory"></span></td>
                            ...
                            <tr>
                                ...
                                <td class='text' style="width:280px;"><input type='password' name=adminPass style="width:120px;" value="" autocomplete='off' class="form-control">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name='fname' id='fname' style="width:120px;" class="form-control"><span class="mandatory"></span></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name='lname' id='lname' style="width:120px;" class="form-control"><span class="mandatory"></span></td>
                                <td><span class=text><?php echo xlt('Suffix'); ?>: </span></td>
                                <td><input type="text" name=suffix id=suffix style="width:150px;" class="form-control"></td>
                            </tr>
                            <tr>
                                <td><span class=text><?php echo xlt('Valedictory'); ?>: </span></td>
                                <td><input type="text" name=valedictory id=valedictory style="width:150px;" class="form-control"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="erxprid" style="width:120px;" class="form-control" value="<?php echo attr($iter["weno_prov_id"] ?? ''); ?>"></td>
